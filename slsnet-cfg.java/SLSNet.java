...
public class SLSNet {
    ...
    @Reference(cardinality = ReferenceCardinality.MANDATORY_UNARY)
    protected SLSNetConfigurationService config;
    ...
    private SLSNetProcessor processor = new SLSNetProcessor();

    @Activate
    public void activate() {
        appId = coreService.registerApplication(APP_NAME);
        intentRequestListener = new SLSNetFib(appId, hostService,
    ...
    private class SimpeLeafSpineNetworkProcessor implements PacketProcessor {
        @Override
